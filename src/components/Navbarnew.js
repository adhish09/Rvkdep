          ...
          <nav className="navbar486">
            ...
            <ul>
              ...
              {!user ? (
                    ...
                    <button to="login" className="button5878">
              ...
              <ul>
                ...
                <li  onClick={handleClick1}><button className="translanguagebutton1" onClick={changeLanguage("en")}>English</button></li>
                <li  onClick={handleClick1}><button className="translanguagebutton1" onClick={changeLanguage("hi")}>हिंदी</button></li>
              </ul>
